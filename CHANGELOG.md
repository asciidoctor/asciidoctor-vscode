...
* Raise the minimum VS Code version to 1.97 to use the finalized drag-and-drop edit API (multiple drop options with titles), needed for the copy-on-drop feature
