...
export namespace AsciidocContributions {
  ...
  export function merge(
    a: AsciidocContributions,
    b: AsciidocContributions,
  ...
  function getContributedScripts(
    ...
    return resolveExtensionResources(
      extension,
      contributes['asciidoc.previewScripts'],
    )
  }
  ...
  function getContributedStyles(
    ...
    return resolveExtensionResources(
      extension,
      contributes['asciidoc.previewStyles'],
    )
  }
}
...
class VSCodeExtensionAsciidocContributionProvider
  extends Disposable
  implements AsciidocContributionProvider
{
    ...
    vscode.extensions.onDidChange(
      () => {
        ...
        const existingContributions =
          this._contributions || AsciidocContributions.Empty
        if (
          !AsciidocContributions.equal(
...
export function getAsciidocExtensionContributions(
