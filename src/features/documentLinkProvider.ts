  ...
  public provideDocumentLinks (
    ...
    baseDocumentConverterLinks.forEach((link, idx) => {
      ...
      try {
        ...
        if (link.type === 'xref' && lines[lineNumber][startPos] === '<') {
          startPos += 2
          endPos += -2
        }
