...
export async function getAttributes (_: Uri): Promise<{ [key: string]: string }> {
  return {}
}

export async function getAntoraDocumentContext (_: Uri, __: Memento): Promise<AntoraDocumentContext | undefined> {
  return undefined
}
